...
<script>
	...
	$(document).ready(function(){
		$('#btn').click(function(){
			...
			}else if($('#changePw').val() == ''){
				alert('변경할 비밀번호를 입력해주세요');
			}else if($('#confirmPw').val() == ''){
				alert('비밀번호 재확인을 입력해주세요');
			}else {
				$('#modifyEmpMyPage').submit();
			}
		});
	});
</script>
	...
	<section class="bg0 p-t-75 p-b-116">
		<div class="container">
			<div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md cen">
				<form action="<%=request.getContextPath()%>/employees/modifyEmpMyPageAction.jsp" method="post" id="modifyEmpMyPage">
					...
					<div class="bor8 m-b-20 how-pos4-parent">
						<input class="mtext-107 cl2 plh3 size-116 p-l-62 p-r-30"  type="text" name="empName" id="empName" value="<%=employees.getEmpName() %>">
					</div>	
					<div class="bor8 m-b-20 how-pos4-parent">
						<input class="mtext-107 cl2 plh3 size-116 p-l-62 p-r-30"  type="password" name="currentPw" id="currentPw" placeholder="현재 비밀번호">
					</div>
					<div class="bor8 m-b-20 how-pos4-parent">
						<input class="mtext-107 cl2 plh3 size-116 p-l-62 p-r-30"  type="password" name="changePw" id="changePw" placeholder="변경 비밀번호">
					</div>
					<div class="bor8 m-b-20 how-pos4-parent">
						<input class="mtext-107 cl2 plh3 size-116 p-l-62 p-r-30"  type="password" name="confirmPw" id="confirmPw" placeholder="변경 비밀번호 확인">
					</div>
